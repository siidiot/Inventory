...
public function __construct()
	...
	public function index()
	{
		...
		$this->template->load('template', 'laporan/menu',$data);
	}
	public function periode()
	{
		if (isset($_POST['submit'])) {
	        ...
	        $record= $this->model_transaksi->get_periode($tgl1,$tgl2);
	        $tgl  = "$tgl1 s/d $tgl2";
      ...
      $pdf->SetFont('Arial','B','L');
        $pdf->SetFontSize(16);
       $pdf->Text(105, 40, "LAPORAN DATA TRANSAKSI  ");
       $pdf->Text(95, 45, "PERIODE $tgl");
       $pdf->Text(100, 50, 'PT.SINAR AGUNG METALINDO');
       ...
       foreach ($record->result() as $r) {
        ...
        $pdf->Output("lap_transaksi_$tgl.pdf",'i');
		}
		$data['title']   = "Laporan";
		$data['subtitle']= ""; 
		$data['url']     = "master";
