     <?php echo form_open('customer/add_data', ['class'=>'form-horizontal','role'=>'form', 'id'=>'jvalidate'])?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Tambah Data</strong> Customer</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                        <input type="text" readonly="" value="<?=$kodeunik?>" class="form-control" id="id" name="id" />
