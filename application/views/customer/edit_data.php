...
<?php echo form_open('customer/edit/'.$record->cust_id, ['class'=>'form-horizontal','role'=>'form', 'id'=>'jvalidate'])?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Edit Data</strong> Customer</h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                        <input type="text" class="form-control" disabled name="id" value="<?=$record->cust_id?>" />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9"> 
                                                        <input type="text" class="form-control" name="nama" id="nama" value="<?=$record->nama_customer?>" />
